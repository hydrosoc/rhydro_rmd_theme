...
<h1> Intro to project R in Hydrology <br> 
with git, `r fontawesome::fa("github", fill = fa_color)` GitHub and RStudio </h1>

<br>


<h3> John Doe <br> <em>University of Life</em> </h3>
<br>
<br>
...
background-image: url(./static/img/rhydro_logo.png)

???

These question marks start the note section.
Just an example of setting a background image.
...
<div class="my-header">Presentation Title </div>


<div class="my-footer"><span> J. Doe, @twitter - bit.ly/slidelinks   </span></div> 

???

Feel free to remove these. Note, that layout: true is required to keep
header and footer on subsequent slides.
...
<iframe src="https://wall2.sli.do/event/l8mec4wj" width="800" height="600" scrolling="no"></iframe> 
---
